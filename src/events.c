...
*/
  ...
  _DOFUN(do_event) {
    ...
    if (!str_cmp(arg1, "target")) {
      ...
      send_to_char("Valid group target keywords: Supernaturals, Naturals, Vampires, Vampire, Werewolves, Werewolf, Faeborn, Angelborn, Demonborn, Demigods, [Faction name without spaces], (Alliance Name), (Character name), Everyone\n\r", ch);
